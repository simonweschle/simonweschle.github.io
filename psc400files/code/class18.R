...
# NOTE: do loop first, then set up poll.pred
...
hist(pres08$error, freq=F, xlab="Error in Predicted Margin for Obama")
abline(v=mean(pres08$error), lty=2)
