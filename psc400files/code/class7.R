...
dis <- read.csv("~/Dropbox/Teaching/2024_1_PSC_400/classes/week_3/data/UK_districts.csv")
...
congress <- read.csv("~/Dropbox/Teaching/2024_1_PSC_400/classes/week_3/data/congress.csv")
