...
# load the quality of government dataset (qog_bas_cs_jan24.csv)

# from the variable p_polity2, create a new variable called democracy that takes the value of 1 if p_polity2 is 6 or larger, and zero otherwise
